<?php
	$title= "FAQs - Retail Food Service Establishments" ;
	include '../includes/header.html';
    include '../includes/menus/foodest_menu.html'; 
?>

<hr />
<p><strong>Why is it necessary to permit and inspect retail food operations?</strong></p>
...
<hr />
<p><strong>What type of retail food businesses need a retail food permit?</strong></p>
...
<p>The Texas Food Establishment Rules’ definition for PHF states that Potentially hazardous food (PHF) means a food that requires time and temperature control for safety (TCS) to limit pathogen growth or toxin production. Potentially hazardous food includes: an animal food (a food of animal origin), including fresh shell eggs, that is raw or heat-treated; a food of plant origin that is heat-treated or consists of raw seed sprouts; cut melons; and garlic-in-oil mixtures that are not modified in a way that results in mixtures that do not support growth of pathogens or production of toxin. </p>
<hr />
<p><strong>How do I file a complaint?</strong></p>
<p>The Texas Department of State Health Services (DSHS) will investigate a complaint that pertains to a retail food establishment located in an area where DSHS has regulatory jurisdiction. DSHS has regulatory jurisdiction and enforces the TFER in those areas of the state that are not permitted or inspected by a local health authority. You should contact the appropriate local health department, if your complaint pertains to an establishment located in an area with a local health department. Please see the "<a href="/foodestablishments/complaints.aspx">Complaint Process</a>" page for information on filing a complaint or contact the Food Establishment Group at (512) 834-6753, if you would like to discuss your complaint, file a complaint by telephone, or find the contact information for the appropriate local health department. </p>
