<?php
	$title= "Notifications - Asbestos Program" ;
...
<p>The Demolition/Renovation form must be used whether you are notifying in accordance with NESHAP, TAHPR, or both. The notification form must be postmarked at least 10 working days (not calendar days) prior to the project start date (except for emergencies or ordered demolitions). Notifications which do not meet the 10-day requirement or are incomplete are considered to be "improper" and may result in enforcement proceedings. If an item on the form is not applicable to the project in question, you must write "N.A." in that space.</p>
...
<p>Notifications are regulated by the following rules:</p>
<ul>
	<li><a title="National Emission Standards for Hazardous Air Pollutants (NESHAP), 40 CFR, Part 61" href="http://www.ecfr.gov/cgi-bin/text-idx?SID=d57206f844491a545fd75b6d342775aa&mc=true&node=pt40.9.61&rgn=div5">National Emission Standards for Hazardous Air Pollutants (NESHAP), 40 CFR, Part 61</a></li>
