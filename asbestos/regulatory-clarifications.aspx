...
<ul>
	<li><a title="Resilient Floor Coverings" href="#floors">Resilient Floor Coverings</a></li>
	<li><a title="Regulatory Clarification Documents" href="#clarification">Regulatory Clarification Documents</a></li>
	<li><a title="Policy Letters" href="#policy">Policy Letters</a>
		<ul>
			<li><a title="Notification of Phased Projects" href="#phased">Notification of Phased Projects</a></li>
			<li><a title="Recognition of Emergency Notification" href="#emergency">Recognition of Emergency Notification</a></li>
		</ul>
	</li>
</ul>
<hr/>
<a class="bookmark" title="floors" name="floors"></a>
...
<table class="zebraBorder layout" summary="Sorted chronologically by date (descending)" style="width:100%;">
	...
	<thead>
		<tr>
			<th id="table_heading_0" style="width:10%;">Date</th>
			<th id="table_heading_1" style="width:70%;">Description</th>
			<th id="table_heading_2" style="width:20%;">Publication Number / Link</th>
		</tr>
	</thead>
	<tbody>
		<tr>
			<td headers="table_heading_0">2011-03</td>
			<td headers="table_heading_1">Removal of Non-Asbestos Flooring Adhered to Asbestos-Containing Adhesive/Mastic and the Applicability of the Resilient Floor Coverings Institute (RFCI) Recommended Work Practices</td>
			<td headers="table_heading_2"><a title="PSQA-ASB002" href="http://www.dshs.state.tx.us/WorkArea/linkit.aspx?LinkIdentifier=id&amp;ItemID=8589953486">PSQA-ASB002</a> <br/><span class="small">(PDF, 44KB)</span></td>
		</tr>
		<tr>
			<td headers="table_heading_0">2007-05</td>
			<td headers="table_heading_1">Demolition of Small Residential Buildings by Municipalities</td>
			<td headers="table_heading_2"><a title="PSQA-ASB001" href="http://www.dshs.state.tx.us/WorkArea/linkit.aspx?LinkIdentifier=id&amp;ItemID=8589953485">PSQA-ASB001</a> <br/><span class="small">(PDF, 27KB)</span></td>
		</tr>
	</tbody>
</table>
...
<hr/>
<a class="bookmark" title="policy" name="policy"></a>
<h2>Policy Letters</h2>
<a class="bookmark" title="phased" name="phased"></a>
<h3>Policy Letter 295.61(a) - #2, Notification Of Phased Projects</h3>
<p><strong>December 9, 1996</strong></p>

<p><strong>(This policy replaces all previous policies and/or guidelines)</strong></p>
<p>The following policy is adopted to help the regulated community comply with the intent and spirit of the Texas Asbestos Health Protection Rules (Rules) and the National Emission Standards for Hazardous Air Pollutants (NESHAP). This policy outlines the notification procedures for phased projects.</p>
<p>To Be a Phased Project:</p>
<ul>
	<li>All of the abatement work must be performed at one site by one contractor. The site may contain more than one building, such as an office complex, military base, or university, but will have a single address. The total number of buildings that will be involved in the abatement project must be listed in "Description of area" in Item #4. The amount of asbestos-containing material that will be abated from all of the buildings shall be combined and the total amount listed in Item #12.  </li>
	<li>There shall not be more than 30 days between the phases. If more than 30 days pass from the time of final air clearance from one phase to the start of the next phase, they are considered separate projects and a new, original notification must be submitted 10 days before the next phase. All notification procedures including those for completion dates, amendments and cancellations will still be required.</li>
</ul>

<p>To Notify:</p>
<ul>
	<li>The notification form must state that the renovation will be a phased project. The appropriate block in Item #5 on the current notification form must be marked. The abatement dates in Item #16 will be the overall dates of the project (first start date and final completion date) and shall encompass no more than one calendar year. Do not submit an amendment for each phase of the project. Only amend the first and final dates as appropriate. </li>
	<li>Verbal communication must be made to the appropriate Texas Department of State Health Services inspector or Local Program inspector. Keep them informed of the period of time between phases and any other times when work is not being performed. If they cannot be reached, leave a message or call the central office in Austin. The Regional offices may want a FAX in addition to a phone call.
		<ul>
			<li>Failure to comply with this policymay result in enforcement of §295.61(a) Operations: Notifications, (a) General Provision.</li>
		</ul>
	</li>
</ul>
<p>Questions may be directed to the regional/local program office or the central office in Austin at either (512) 834-6770 or 1-800-572-5548 (Texas only).</p>
<hr/>

<a class="bookmark" title="emergency" name="emergency"></a>
<h3>Policy Letter 295.61(h) - #1, Recognition of Emergency Notification</h3>
<p><strong>December 9, 1996</strong></p>

<p><strong>(This policy replaces all previous policies and/or guidelines, including the original unsigned version dated February 8, 1996)</strong></p>

<p>There may be some misunderstanding regarding the verification of an emergency for the 10 working day requirement for asbestos abatement or building demolition notification. There have been several cases where emergency notification was requested for "financial loss if a job is shut down waiting" or "that if not allowed to start will cost the company $X."</p>

<p>In and of itself the foregoing does not constitute an emergency under the Texas Asbestos Health Protection Act (TAHPA) or the National Emission Standards for Hazardous Air Pollutants (NESHAP). If the company affected an emergency, it still must be proven by them or they will be found in violation of an improper notification. <strong>40 CFR Subpart M, §61.141 of the NESHAP defines an emergency renovation operation as a renovation operation that was not planned but results from a sudden, unexpected event, that is necessary to avoid imposing an unreasonable financial burden. This term includes operations necessitated by nonroutine failures of equipment.</strong> Failure to plan for work, for which one could have prepared does not constitute an emergency. An inspection, by a TDH inspector will be performed to ensure the emergency is valid.</p>

<ul>
	<li>Examples of a valid emergency are: <strong>1)</strong> when abatement has been performed and renovation or demolition has begun, and ACM is found in an area which could not have been known because it was hidden from view; and <strong>2)</strong> when a boiler which provides heat to a building suddenly fails and needs immediate replacement in winter because the contents of the structure will be severely damaged without the heat, or the building must be occupied by people who have no other place to go. </li>
	<li>In cases where there appears to be a valid emergency, we request that you call the department regional or local program inspector. If the inspector concurs with your request then an emergency number will be issued, which must be listed on the subsequent notification form. If you are unable to contact the field inspector, the central office in Austin may then be contacted. When emergencies occur at times when no one can be contacted, write a full justification and attach it to the notification form to be sent to the central office in Austin in compliance with§295.61(h) of the TAHPA (1994). No approval is required, however, the burden of proof rests with the notifier.</li>
</ul>

<p>One recent case involved a chain store in a small town in the central part of the state. The competition had gone out of business. This remaining store was the only one in easy commuting distance which could provide the service. As a result, customers were parking across the street in a parking lot at a closed store. The headquarters of the remaining store bought the property and were seeking to quickly demolish the abandoned building and repave the parking lot. Their claim for an emergency was the threat to public health of the abandoned building and that it would cost the company too much money to delay the project. It also appears that there was no survey on the building to be demolished. The request for an emergency notification was denied.</p>

<p>We are trying to ensure that we all are applying the policy in a uniform fashion. The report from the regional or local program inspector tells us whether or not the job is in compliance, and if not, is the basis to issue a Notice of Violation.</p>

<p>Questions may be directed to the regional/local program office or the central office in Austin at either (512) 834-6770 or (800) 572-5548 (Texas only).</p>
