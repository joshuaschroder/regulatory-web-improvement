...
<ul>
	...
	<li><a title="Payment of Biennial Fees" href="#admin-renewal">Payment of Biennial Fees</a></li>	
	<li><a title="Technical Renewal of Registration" href="#technical-renewal">Technical Renewal of Registration</a></li>
...
<div class="Section" id="Admin-Renewal">
	<a class="bookmark" title="admin-renewal" name="admin-renewal"></a>
	<hr/>
	<h2>Payment of Biennial Fees (Administrative Renewal)</h2>
	<p>A fee must be paid every two years in order to continue operating X-ray machines. This biennial fee is known as <em>administrative renewal</em>.</p>
	<p>Registrants will receive an invoice by mail approximately 60 days prior to the fees being due, and payments may be submitted online. For detailed instructions on how to pay administrative renewal fees online, please see the <a title="X-Ray Administrative Renewal Online Payment Instructions" href="admin-renewal-payment.aspx">X-Ray Administrative Renewal Online Payment Instructions</a> page.</p>
</div>

<div class="Section" id="Technical-Renewals">
	...
	<table class="zebraBorder layout" summary="">
		...
		<thead>
			<tr>
				...
				<th id="table_heading_2">Notes</th>
			</tr>
		</thead>
		<tbody>
			<tr>
...
<div class="Section" id="Accelerator">
	...
	<ul>
		<li>
			<h3>Registration of a New Accelerator</h3>
