...
<table class="zebraBorder layout" summary="sorted by document number, descending" style="width:100%;">
	<caption>Applications and Forms Required for Licensing of Naturally Occurring Radioactive Materials</caption>
	<thead>
		<tr>
...
<p>When applying for a mobile NORM decontamination license, please see <a title="" href="http://www.dshs.state.tx.us/WorkArea/linkit.aspx?LinkIdentifier=id&amp;ItemID=8589981714">Regulatory Guide 2.18 - Preparation of Radioactive Material License Applications
for Decontamination Services</a> <span class="small">(PDF, 106KB)</span>.</p>
...
<p>See the <a title="Laws and Rules page" href="/radiation/ram/laws-rules.aspx#norm">Laws and Rules page</a> for a list of applicable statutes and regulations pertaining to NORM licensing.</p>
