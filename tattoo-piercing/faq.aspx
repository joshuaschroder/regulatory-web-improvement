...
<p><strong>I moved my studio across the street. Is my license still good?</strong></p>
<p>No. In the event a tattoo/body piercing studio changes name or ownership or moves to another location (even if it is next door), a new <a title="Tattoo Studio License Application" href="/tattoo-piercing/forms.aspx">Tattoo Studio License Application</a> and/or <a title="Body Piercing Studio License Application" href="/tattoo-piercing/forms.aspx">Body Piercing Studio License Application</a> must be submitted along with the appropriate fee.<br/><br/></p>

<p><strong>I want to use a mobile studio to take to different events. What do I need to do?</strong></p>
<p>Tattoo and body piercing studio licenses are address specific, so a license is required at each location or event where you are going to operate a studio. Mobile studios, such as trailers, are allowed to be used at events as long as they are to be used specifically for tattooing and body piercing, they do not contain living quarters, and they comply with all other aspects of the <a title="Tattoo and Body Piercing Rules" href="/tattoo-piercing/laws-rules.aspx">Tattoo and Body Piercing Rules</a>.<br/><br/></p>

<p><strong>Why do I need to maintain owner’s manuals for my sterilizer and ultrasonic cleaner here at my studio?</strong></p>
<p>Instructions on how to operate the device and provide appropriate maintenance are included in the owner’s manuals. Investigators review these manuals during inspections to see if you are using the devices to specifications and providing the recommended maintenance.<br/><br/></p> 

<p><strong>What do the rules mean by “unobstructed access” to hand-washing facilities and why?</strong></p>
...
<ul>
	<li>Studios can accept a notarized consent from the parent that contains the name, address, and phone number of the minor and the parent; the location on the body to be pierced; and the signatures of both the parent and the minor.</li>
	<li>The parent can sign a consent form at the studio stating that they will remain at the studio during the piercing; they have the authority to consent to the piercing; they presented identification for the minor; and they presented evidence that they are the parent. Studios are responsible for demonstrating a clear relationship between the adult and the minor (i.e. same last names and addresses on identification).</li>
</ul>
<p>In both cases, studios are still required to complete a client record for the minor and retain the consent form. This includes recording the minor’s I.D., the parent’s I.D. (when the parent is present), and other materials provided demonstrating a parental relationship.<br/><br/></p>

<p><strong>Is a library card or student I.D. adequate identification for customers to provide when receiving a tattoo or body piercing?</strong></p>
<p>Not for persons over 18 years of age. Library cards and student I.D. cards are not considered acceptable forms of identification for adults because there is no uniformity between libraries or schools to allow your studio to determine if the I.D. is valid. The rules state clients must present a valid, government issued, positive identification card, which includes a photograph and the date of birth. Several types of identification commonly seen include a driver’s license, passport, military identification, and Department of Public Safety issued I.D. cards.<br/><br/></p>

<p><strong>What is the procedure in the event a client is injured or gets an infection from tattoo/body piercing services?</strong></p>
