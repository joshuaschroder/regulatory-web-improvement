<?php
	$title= "Other Certifications Accepted by Texas - Industrial Radiographer Certification" ;
	include '/home/codio/workspace/includes/header.html';
    include '/home/codio/workspace/includes/menus/rad2_ir_menu.html'; 
?>

<p>Texas will accept an individual's radiographer certification if the individual or company submits a clear, legible copy (front and back) of the valid certification from an entity recognized by Texas in accordance with <a title="25 TAC §289.255(l)(2)-(4)" href="/radiation2/laws-rules.aspx#289255">25 TAC §289.255(l)(2)-(4)</a>. No forms need to be completed.</p>
...
<table class="zebraBorder layout" summary="sorted alphabetically by state" style="width:70%;">
	...
	<thead>
		<tr>
			<th id="table_heading_0" style="width:25%;">State</th>
			<th id="table_heading_1" style="width:75%;">Certification Type</th>
		</tr>
	</thead>
	<tbody>
		<tr>
			<td headers="table_heading_0">Alabama</td>
			<td headers="table_heading_1">RAM, X-Ray, Both</td>
		</tr>
		<tr>
			<td headers="table_heading_0">Georgia</td>
			<td headers="table_heading_1">RAM</td>
		</tr>
		<tr>
			<td headers="table_heading_0">Illinois</td>
			<td headers="table_heading_1">RAM, X-Ray, Both</td>
		</tr>
		<tr>
			<td headers="table_heading_0">Iowa</td>
			<td headers="table_heading_1">RAM, X-Ray, Both</td>
		</tr>
		<tr>
			<td headers="table_heading_0">Louisiana</td>
			<td headers="table_heading_1">RAM, X-Ray, Both</td>
		</tr>
		<tr>
			<td headers="table_heading_0">Maine</td>
			<td headers="table_heading_1">RAM, X-Ray, Both</td>
		</tr>
		<tr>
			<td headers="table_heading_0">North Dakota</td>
			<td headers="table_heading_1">RAM, X-Ray, Both</td>
		</tr>
		<tr>
			<td headers="table_heading_0">Oklahoma</td>
			<td headers="table_heading_1">RAM, Both</td>
		</tr>
	</tbody>
</table>
<p>Texas also accepts IRRSP RAM, X-Ray and Both certifications issued by the American Society for Nondestructive Testing Inc. (ASNT).</p>

<hr/>
<h2>Contacts for Certifying Entities Outside of Texas</h2>
<table class="zebraBorder layout" summary="sorted alphabetically by entity" style="width:100%;">
	<caption>Points of Contact for External Certifying Entities</caption>
	<thead>
		<tr>
