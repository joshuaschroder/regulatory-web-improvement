<?php
	$title= "Licensing Requirements for Drug Manufacturers, Distributors, and Cosmetic Products" ;
...
<p>We require all businesses that distribute drugs to anyone other than the consumer or patient to <a title="license with the Texas Department of State Health Services" href="/drugs/forms.aspx#distributors">license with the Texas Department of State Health Services</a> (DSHS). We routinely inspect wholesale drug distributors to determine compliance with state and federal laws governing the distribution of drugs. Examples of drug distributors: </p>
<ul>
...
<p>Any business, including <a title="manufacturers within another state" href="/drugs/forms.aspx#out-of-state">manufacturers within another state</a> that distribute drugs into the state of Texas, is required to license with DSHS. This process allows DSHS to track the interstate movement of the drugs between the states. </p>
