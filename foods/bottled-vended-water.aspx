<?php
	$title= "Bottled and Vended Water - Food Manufacturers, Wholesalers, and Warehouses" ;
...
<div class="suggResults" style="width:97%;padding:15px;">
	...
	<h2>State of Texas Eliminates Licensing and Regulation of Seven Occupations/Businesses</h2>
	<br>
	<p>A new state law, Senate Bill 202, was recently passed by the Texas Legislature.  The new law becomes effective September 1, 2015.  State law will no longer require a license issued by the Department of State Health Services (DSHS) for the following businesses and occupations: </p>
	
	<ul>
		<li>Rendering businesses</li>
		<li>Contact lens dispensers</li>
		<li>Opticians</li>
		<li>Bedding</li>
		<li>Tanning facilities</li>
		<li>Personal emergency response providers</li>
		<li>Bottled and vended water certificates of competency</li>
	</ul>
	
	<p>On and after July 1, 2015, DSHS will not issue new licenses or renew expiring licenses for these programs. </p>
	...
	<p>DSHS will soon be notifying license holders and interested parties directly of this change in Texas law.  If you have questions, please contact us via e-mail at <a title="foodslicensinggroup@dshs.state.tx.us" href="mailto:foodslicensinggroup@dshs.state.tx.us?subject=Deregulation%20of%20Bottled/Vended%20Water%20Certificate%20of%20Competency">foodslicensinggroup@dshs.state.tx.us</a>.</p>
...
<ul>
	...
	<li>Dispense water through stand alone vending machines. Each vending machine must be licensed separately</li>
</ul>

<h3>Certificates</h3>
<p>Only one type certificate will be issued. The certificate is valid for up to two years and fees are $106.00. In addition, for all applications and renewal applications, DSHS is authorized to collect subscription and convenience fees in amounts determined by the Texas Online Authority to recover costs associated with applications and renewal processing through Texas Online.</p>

<h3>Examinations</h3>
<p>An applicant must pass an examination provided by the Texas Department of State Health Services to receive a certification. All exam questions will be from material in the <a title="Bottled and Vended Water Operator Certification Manual" href="http://www.dshs.state.tx.us/WorkArea/linkit.aspx?LinkIdentifier=id&amp;ItemID=8589964521">Bottled and Vended Water Operator Certification Manual</a> <span class="small">(PDF, 946KB)</span>.</p>
<p>You must complete an exam application.</p>
<p>Exams may be taken in various <a title="public health regional offices" href="#exam-sites">public health regional offices</a> throughout the state after an application has been received and approved from the main office in Austin. </p>

<h3>Renewals </h3>
<p>All certificates expire two years from the date of issuance. A renewal certificate costs $106.00. As stated above, subscription and convenience fees will be added.</p>
...
<h2>Bottled and Vended Water Operator Certification Examination Sites</h2>
...
<p>
	<strong>Deborah Runk, R.S.</strong><br/>
	1233 Agnes St.<br/>
...
<p>
	<strong>Charles Mullin</strong><br/>
	622 South Oaks, Suite 8<br/>
