...
<div class="section" id="TOC">
	...
	<ul>
		<li><a title="Texas Laws" href="#laws">Texas Laws</a></li>
		<li><a title="Rules and Regulations" href="#rules">Rules and Regulations</a>
			<ul>
				<li><a title="Administration, Fees, Exemptions, and Enforcement" href="#admin">Administration, Fees, Exemptions, and Enforcement</a></li>
				<li><a title="Notices, Instructions, and Reports to Workers" href="#notices">Notices, Instructions, and Reports to Workers</a></li>
				<li><a title="X-Ray Machines and Lasers" href="#registration">X-Ray and Laser Registration</a>
					<ul>
						<li><a title="Medical Uses (General)" href="#medical">Medical Uses (General)</a></li>
						<li><a title="Dental" href="#dental">Dental</a></li>
						<li><a title="Industrial" href="#industrial">Industrial</a></li>
						<li><a title="Mammography" href="#mammography">Mammography</a></li>
						<li><a title="Veterinary" href="#veterinary">Veterinary</a></li>
					</ul>
				</li>
				<li><a title="Industrial Radiographers" href="#IR">Industrial Radiographer Certification</a></li>
				<li><a title="Radioactive Material (RAM) Licensing and Safety" href="#RAM">Radioactive Material (RAM) Licensing and Safety</a></li>
			</ul>
		</li>
	</ul>
</div>
...
<hr/>
<a class="bookmark" title="rules" name="rules"></a>
<h2>Rules and Regulations - Title 25, Texas Administrative Code</h2>

<div class="section" id="Admin">
	<a class="bookmark" title="admin" name="admin"></a>
	<h3>Administration, Fees, Exemptions, and Enforcement</h3>
	<table class="zebraBorder layout" summary="sorted by rule number, ascending" style="width:100%;">
		<caption>Rules Covering Administration, Fees, Exemptions, and Enforcement</caption>
		<thead>
			<tr>
...
<div class="section" id="Notices">
	<br/>
	<a class="bookmark" title="notices" name="notices"></a>
	<h3>Notices, Instructions, and Reports to Workers</h3>
	<table class="zebraBorder layout" summary="sorted by rule number, ascending">
		<caption>Notices, Instructions, and Reports to Workers</caption>
		<thead>
			<tr>
				<th id="table_heading_0" style="width:20%;">Rule</th>
				<th id="table_heading_1" style="width:60%;">Title</th>
	...
	<div class="section-notes">
		...
		<p>
			...
			RC Form 203-1 - For Dentists, see below in <a title="Dental Rule (289.232)" href="#dental-notice">Dental Rule (289.232)</a><br/>
			For Veterinarians, see below in <a title="Vet Rule (289.233)" href="#vet-notice">Vet Rule (289.233)</a> <br/>
			For Laser Hair Removal (LHR) facilities, see below in <a title="LHR Rule (289.302)" href="#LHR-notice">LHR Rule (289.302)</a>
		</p>
		<hr/>
	</div>
</div>
...
<div class="section" id="Registration">
	<br/>
	<a class="bookmark" title="registration" name="registration"></a>
	<h3>X-Ray Machines and Lasers</h3>
	
	<table class="zebraBorder layout" summary="sorted by rule number, ascending">
		<caption>X-Ray Machines and Lasers</caption>
		<thead>
			<tr>
				<th id="table_heading_0" style="width:20%;">Rule</th>
				<th id="table_heading_1" style="width:60%;">Title</th>
		...
		<tbody>
			...
			<tr>
				<td headers="table_heading_0">
					...
					<a title="Texas Administrative Code, Title 25, &#167;289.301 (PDF)" href="https://www.dshs.state.tx.us/WorkArea/linkit.aspx?LinkIdentifier=id&ItemID=8589946026">&#167;289.301 <span class="small">(PDF, 261KB)</span></a>
					<a class="bookmark" title="289301" name="289301"></a>
				</td>
			...
			<tr>
				<td headers="table_heading_0">
					...
					<a title="Texas Administrative Code, Title 25, &#167;289.302 (PDF)" href="https://www.dshs.state.tx.us/WorkArea/linkit.aspx?LinkIdentifier=id&ItemID=8589946028">&#167;289.302 <span class="small">(PDF, 751KB)</span></a>
					<a class="bookmark" title="289302" name="289302"></a>
				</td>
...
<div class="section" id="Medical">
	...
	<br/>
	<hr/>
	<a class="bookmark" title="medical" name="medical"></a>
	<h4>X-Ray Machines and Lasers - Medical Uses (General)</h4>
	<table class="zebraBorder layout" summary="sorted by rule number, ascending">
		<caption>X-Ray Machines and Lasers - Medical Uses (General)</caption>
		<thead>
			<tr>
				<th id="table_heading_0" style="width:20%;">Rule</th>
				<th id="table_heading_1" style="width:60%;">Title</th>
...
<div class="section" id="Dental">
	<br/>
	<a class="bookmark" title="dental" name="dental"></a>
	<h4>X-Ray Machines and Lasers - Dental Uses</h4>	
	<table class="zebraBorder layout" summary="sorted by rule number, ascending">
		<caption>X-Ray Machines and Lasers - Dental Uses</caption>
		<thead>
			<tr>
				<th id="table_heading_0" style="width:20%;">Rule</th>
				<th id="table_heading_1" style="width:60%;">Title</th>
...
<div class="section" id="Industrial">
	<br/>
	<hr/>
	<a class="bookmark" title="industrial" name="industrial"></a>
	<h4>X-Ray Machines and Lasers - Industrial Uses</h4>	
	<table class="zebraBorder layout" summary="sorted by rule number, ascending">
		<caption>X-Ray Machines and Lasers - Industrial Uses</caption>
		<thead>
			<tr>
				<th id="table_heading_0" style="width:20%;">Rule</th>
				<th id="table_heading_1" style="width:60%;">Title</th>
...
<div class="section" id="Mammography">
	...
	<h4>X-Ray Machines and Lasers - Mammography</h4>
	<table class="zebraBorder layout" summary="sorted by rule number, ascending">
		<caption>X-Ray Machines and Lasers - Mammography</caption>
		<thead>
			<tr>
				<th id="table_heading_0" style="width:20%;">Rule</th>
				<th id="table_heading_1" style="width:60%;">Title</th>
...
<div class="section" id="Veterinary">
	<br/>
	<hr/>
	<a class="bookmark" title="veterinary" name="veterinary"></a>
	<h4>X-Ray Machines and Lasers - Veterinary Uses</h4>
	<table class="zebraBorder layout" summary="sorted by rule number, ascending">
		<caption>X-Ray Machines and Lasers - Veterinary Uses</caption>
		<thead>
			<tr>
				<th id="table_heading_0" style="width:20%;">Rule</th>
				<th id="table_heading_1" style="width:60%;">Title</th>
...
<div class="section" id="Industrial-Radiographers">
	<br/>
	<hr/>
	<a class="bookmark" title="IR" name="IR"></a>
	<h3>Industrial Radiographer Certification</h3>
	<table class="zebraBorder layout" summary="sorted by rule number, ascending">
		<caption>Industrial Radiographer Certification</caption>
		<thead>
			<tr>
				<th id="table_heading_0" style="width:20%;">Rule</th>
				<th id="table_heading_1" style="width:60%;">Title</th>
...
<div class="section" id="Materials">
	...
	<h3>Radioactive Material (RAM) Licensing and Safety</h3>
	<table class="zebraBorder layout" summary="sorted by rule number, ascending">
	<caption>Radioactive Material (RAM) Licensing and Safety</caption>
	<thead>
		<tr>
			<th id="table_heading_0" style="width:20%;">Rule</th>
			<th id="table_heading_1" style="width:60%;">Title</th>
	...
	<tbody>
		...
		<tr>
			...
			<td headers="table_heading_2">06/05/97</td>
			<td headers="table_heading_3"><span class="small"><a title="See Note 289.202-3" href="#289.202-3">See Note 202-3</a></span></td>
		</tr>									
		<tr>
			<td headers="table_heading_0">
