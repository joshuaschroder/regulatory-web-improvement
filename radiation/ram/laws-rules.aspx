<?php
	$title= "Laws and Rules - Radioactive Materials Licensing" ;
	...
	<ul>
		...
		<li><a title="Radioactive Materials License Rules" href="#ram">Radioactive Materials License Rules</a>
			<ul>
				...
				<li><a title="Industrial Radiography RAM" href="#radiography">Industrial Radiography RAM</a></li>
				<li><a title="Irradiator" href="#irradiator">Irradiator</a></li>
				<li><a title="Medical RAM" href="#ram-medical">Medical RAM</a></li>
				<li><a title="Naturally Occurring Radioactive Material (NORM)" href="#norm">Naturally Occurring Radioactive Material (NORM)</a></li>
				<li><a title="Well Logging Radioactive Materials" href="#well-logging">Well Logging</a></li>
			</ul>
		</li>
	</ul>
</div>
...
<div class="section" id="RAM">
	...
	<br/>
	<h3>General License Acknowledgement / Gauge</h3>
	<table class="zebraBorder layout" summary="sorted by rule number, ascending" style="width:100%;">
	...
	<br/>
	<h3>Industrial Radiography RAM</h3>
	<table class="zebraBorder layout" summary="sorted by rule number, ascending" style="width:100%;">
	...
	<a class="bookmark" title="irradiator" name="irradiator"></a>
	<br/>
	<h3>Irradiator</h3>
	<table class="zebraBorder layout" summary="sorted by rule number, ascending" style="width:100%;">
		<caption>Rules Covering Irradiator Licenses for Radioactive Material</caption>
		<thead>
			<tr>
				<th id="table_heading_0" style="width:20%;">Rule</th>
				<th id="table_heading_1" style="width:70%;">Title</th>
	...
	<br/>
	<h3>Naturally Occurring Radioactive Material (NORM)</h3>
	<table class="zebraBorder layout" summary="sorted by rule number, ascending" style="width:100%;">
		<caption>Rules Covering Licensing of Naturally Occurring Radioactive Material</caption>
		<thead>
			<tr>
				<th id="table_heading_0" style="width:20%;">Rule</th>
				<th id="table_heading_1" style="width:70%;">Title</th>
