...
<div class="class" id="TOC">
	...
	<ul>
		...
		<li><a title="X-Ray Machine Registration Rules" href="#x-ray">X-Ray Machine Registration Rules</a>
			<ul>
				<li><a title="Medical X-Ray" href="#medical-x-ray">Medical X-Ray</a></li>
				<li><a title="Accelerators, Therapeutic Radiation Machines, Simulators, and Electronic Brachytherapy Devices" href="#therapy-accelerators-simulators">Accelerators, Therapeutic Radiation Machines, Simulators, and Electronic Brachytherapy Devices</a></li>
				<li><a title="Dental X-Ray" href="#dental-x-ray">Dental X-Ray (Includes Cone Beam CT)</a></li>			
				<li><a title="Veterinary X-Ray" href="#veterinary-x-ray">Veterinary X-Ray</a></li>
				<li><a title="Veterinary X-Ray with Accelerator" href="#veterinary-x-ray-accelerator">Veterinary X-Ray with Accelerator</a></li>			
				<li><a title="Industrial X-Ray" href="#industrial-x-ray">Industrial X-Ray (Includes Minimal Threat)</a>
					<ul>
						<li><a title="Industrial Radiography X-Ray" href="#industrial-radiography">Industrial Radiography X-Ray</a></li>
						<li><a title="Industrial X-Ray Accelerator" href="#industrial-accelerator">Industrial X-Ray Accelerator</a></li>
					</ul>
				</li>
				<li><a title="X-Ray Service Companies" href="#x-ray-services">X-Ray Service Companies</a></li>
			</ul>
		</ul>	
	</div>
	...
	<div class="section" id="X-Ray">
		...
		<br/>
		<h3>Accelerators, Therapeutic Radiation Machines, Simulators, and Electronic Brachytherapy Devices</h3>
		<table class="zebraBorder layout" summary="sorted by rule number, ascending" style="width:100%;">
			<caption>Rules Covering Registration of Accelerators, Therapeutic Radiation Machines, Simulators, and Electronic Brachytherapy Devices</caption>
			<thead>
				<tr>
					<th id="table_heading_0" style="width:20%;">Rule</th>
					<th id="table_heading_1" style="width:70%;">Title</th>
		...
		<br/>
		<h3>Dental X-Ray (Includes Cone Beam CT)</h3>
		<table class="zebraBorder layout" summary="sorted by rule number, ascending" style="width:100%;">
			<caption>Rules Covering Registration of Dental X-Ray Machines, Including Cone Beam CT</caption>
			<thead>
				<tr>
					<th id="table_heading_0" style="width:20%;">Rule</th>
					<th id="table_heading_1" style="width:70%;">Title</th>
		...
		<br/>
		<h3>X-Ray Service Companies</h3>
		<table class="zebraBorder layout" summary="sorted by rule number, ascending" style="width:100%;">
			<caption>Rules Covering X-Ray Service Companies</caption>
			<thead>
				<tr>
					<th id="table_heading_0" style="width:20%;">Rule</th>
					<th id="table_heading_1" style="width:70%;">Title</th>
