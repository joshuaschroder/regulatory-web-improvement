...
<p>In the case of a single certificate of registration that authorizes more than one category of use, the category listed in <a title="25 TAC, &#167;289.204(j)" href="http://texreg.sos.state.tx.us/fids/201105382-2.html">25 TAC, &#167;289.204(j)</a> and assigned the higher fee will be used. If this certificate of registration also has additional authorized use sites, the registrant shall pay an additional 30% of the highest fee category for each additional use location.</p>
