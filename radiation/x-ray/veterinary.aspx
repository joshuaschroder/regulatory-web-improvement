<?php
	$title= "Veterinary X-Ray Machine Registration" ;
...
<table class="zebraBorder layout" summary="sorted in reverse alphabetical order by category" style="width:100%;">
	<caption>Schedule of Application Fees for Veterinary X-Ray Registration</caption>
	<thead>
		<tr>
...
<p>In the case of a single certificate of registration that authorizes more than one category of use, the category listed in <a title="25 TAC, &#167;289.204(j)" href="/radiation/x-ray/laws-rules.aspx#289204"">25 TAC, &#167;289.204(j)</a> and assigned the higher fee will be used. If this certificate of registration also has additional authorized use sites, the registrant shall pay an additional 30% of the highest fee category for each additional use location.</p>
...
<p>To delete or transfer a veterinary X-ray machine, please complete and submit the <a title="Radiation Machine Transfer/Disposal" href="http://www.dshs.state.tx.us/WorkArea/linkit.aspx?LinkIdentifier=id&amp;ItemID=19922">RC-18R, Radiation Machine Transfer/Disposal Form</a> <span class="small">(PDF, 16KB)</span>. Deletions with a replacement in the same category need not be reported. Kepp all install and transfer/disposal records onsire for inspection purposes.</p>
...
<p>In addition to the requirements of 25 TAC §289.226; 25 TAC §289.232; or 25 TAC §289.233, as applicable, each applicant shall apply for and receive authorization for mobile services before beginning mobile service operation. The following shall be submitted.</p>
<ul>
	<li>An established main location where the machine(s), records, etc., will be maintained for inspection.</li>
	<li>A sketch or description of the normal configuration of each x-ray unit’s use, including the operator’s position and any ancillary personnel’s location during exposures. If a mobile van is used with a fixed unit inside, furnish the floor plan indicating protective shielding and the operator’s location.</li>
	<li>Each application for mobile services used in the healing arts shall submit a current copy of the applicant’s Operating and Safety Procedures regarding radiological practices for protection of patients, operators, employees, and the general public.</li>
</ul>

<p>See the <a title="Regulatory Guides page" href="/radiation/x-ray/regulatory-guides.aspx">Regulatory Guides page</a> for the Preparation of Operating and Safety Procedures.</p>
