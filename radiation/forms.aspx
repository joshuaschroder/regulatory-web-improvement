...
<table class="zebraBorder layout" summary="sorted by document number, ascending" style="width:100%;">
	<caption>Radioactive Materials Applications and Forms</caption>
	<thead>
		<tr>
			<th id="table_heading_0" style="width:20%;">Document Number</th>
			<th id="table_heading_1" style="width:80%;">Title</th>
...
<a class="bookmark" title="Laser Registration" name="laser"></a>
<h2>Laser Registration</h2>
...
<a class="bookmark" title="Laser Hair Removal" name="LHR"></a>
<h2>Laser Hair Removal</h2>

<table class="zebraBorder layout" summary="sorted by document number, ascending" style="width:100%;">
	<caption>Laser Hair Removal Applications and Forms</caption>
	<thead>
		<tr>
			<th id="table_heading_0" style="width:20%;">Document Number</th>
			<th id="table_heading_1" style="width:80%;">Title</th>
