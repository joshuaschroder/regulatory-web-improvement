...
<div class="Section" id="New-Certification">
	...
	<ul>
		<li>Complete and submit to the Mammography Certification Program the following forms with the <a title="fee-schedule" href="#fee-schedule">appropriate fee</a>:<br/><br/>
			...
			Each registrant shall have and implement written operation and safety procedures in accordance with <a title="Title 25 of the Texas Administrative Code (TAC) §289.230(hh)(3)" href="/radiation/mammography/laws-rules.aspx#289230">Title 25 of the Texas Administrative Code (TAC) §289.230(hh)(3)</a>.<br/><br/>
			
			Documentation to be submitted with the completed application:
			<ul>
				<li>Policies/procedures requested in Sections 2 of the application: 
						<ul>
...
<div class="Section" id="Equipment-Changes">
	...
	<ul>		
		<li>
			Complete and submit <a title="RC 230-2, Amendment Application for Mammography Certification" href="http://www.dshs.state.tx.us/WorkArea/linkit.aspx?LinkIdentifier=id&amp;ItemID=8589981246">RC 230-2, Amendment Application for Mammography Certification</a> <span class="small">(PDF, 131KB)</span>
		</li>
		<li>Submit a copy of the medical physicist’s survey report for the new unit</li>
...
<div class="Section" id="Personnel-Changes">
	...
	<ul>
		<li>
			<strong><em>Radiation Safety Officer (RSO)</em></strong> - Notify the agency in writing within 30 days by completing and submitting either of the following forms: <br/><br/>
		...
		<li>
			<strong><em>Lead Interpreting Physician (LIP)</em></strong> - Notify the agency in writing within 30 days by completing and submitting either of the following forms: <br/><br/>
