...
<div class="Section" id="New-Certification">
	...
	<ul>
		<li>Contact the Mammography Accreditation Program at (512) 834-6688 ext. 2246, at least 30 days prior to facility opening date, for information regarding the required documents, the correct forms and fees.</li>
	</ul>
	...
	<ul>
		<li>Complete and submit to the Mammography Certification Program the following forms with the <a title="fee-schedule" href="#fee-schedule">appropriate fee</a><br/><br/>
			<table class="zebraBorder layout" summary="sorted by document number, descending" style="width:100%;">
				...
				<tbody>
					<tr>
						<td headers="table_heading_0">RC 230-1</td>
					...
					<tr>
						...
						<td headers="table_heading_1"><a title="Business Information Form - Registration" href="http://www.dshs.state.tx.us/WorkArea/linkit.aspx?LinkIdentifier=id&amp;ItemID=51597">Business Information Form</a> <span class="small">(PDF, 24KB)</span></td>
					</tr>
					<tr>
						<td headers="table_heading_0">RC 42-3</td>
						<td headers="table_heading_1"><a title="Radiation Safety Officer Information for Registration" href="http://www.dshs.state.tx.us/WorkArea/linkit.aspx?LinkIdentifier=id&amp;ItemID=19926">Radiation Safety Officer (RSO) Information</a> <span class="small">(PDF, 301KB)</span></td>
					</tr>
				</tbody>
			</table>
			<br/>
			Application, documentation, and appropriate fees must be submitted at least two weeks prior to providing mammography services. <br/><br/>
			<em>***Note: Hold the Equipment Section of the application until the mammography unit(s) is installed. Submit the completed Equipment Section page with the medical physicist survey report and mammography equipment evaluation. Forty-eight hours after receipt of the application page, medical physicist survey report, and mammography equipment evaluation, the mammography certificates will be issued.</em><br/><br/>
			Documentation to be submitted with the completed application:
			<ul>
				<li>Applicable policies/procedures requested in Sections 2 of the application (see the <a title="Operating and Safety Procedures" href="#procedures">Operating and Safety Procedures</a> section below for more information) </li>
				...
				<li>Current medical physicist’s survey report for each mammography unit</li>
			</ul>
		</li>
		<li>Contact the American College of Radiology</li>
	</ul>
...
<div class="Section" id="Tomosynthesis">
	...
	<hr/>
	<h2>Digital Breast Tomosynthesis (DBT)</h2>
	
	<p><strong><em>A facility must receive approval from the FDA prior to using digital breast tomosynthesis.</em></strong></p>
	<ul>
		<li>Contact the FDA at<br/><br/>
			<img title="Food and Drug Administration Logo" alt="Food and Drug Administration Logo" src="http://www.dshs.state.tx.us/uploadedImages/Content/Regulatory/radiation/fda-logo.jpg" style="width:50px; height:auto;vertical-align:middle;"/> FDA Certification Extension Program - <a title="Digital Breast Tomosynthesis System" href="http://www.fda.gov/Radiation-EmittingProducts/MammographyQualityStandardsActandProgram/FacilityCertificationandInspection/ucm413117.htm">Digital Breast Tomosynthesis System</a><br/><br/>
			<em>**Note:</em> When the FDA Tomosynthesis Approval Letter is received the facility may begin to use the Digital Breast Tomosynthesis portion of the unit.  
		</li>
		<li><strong>New Facilities</strong> - submit a copy of the FDA Tomosynthesis Approval letter to the Mammography Certification Program<br/><br/>
			...
			<ul>
				...
				<li>Copy of the FDA Tomosynthesis Approval Letter </li>
			</ul>
		</li>
	</ul>
...
<div class="Section" id="Renewals">
	...
	<p>The Agency will send a renewal reminder letter and application by mail 2-3 months prior to the expiration date of the mammography certification.  Items requested for a mammography certification renewal are:</p>
	
	<table class="zebraBorder layout" summary="sorted by document number, descending" style="width:100%;">
		<caption>Required forms for mammography certification renewal</caption>
		<thead>
			<tr>
				<th id="table_heading_0">Document Number</th>
				<th id="table_heading_1">Document Title</th>
	...
	<ul>
		<li>Applicable policies/procedures requested in Section 2 of the application.</li>
		<li>Current medical physicist’s survey report for each mammography unit.</li>
	</ul>
	<h3>Facilities Accredited with the State of Texas</h3>
	<p>Facilities accredited with the State of Texas will receive the renewal application, invoice, and instructions via email 8 months prior to the expiration date listed on the facility’s mammography certificates. If renewal email is not received by 6 months of the expiration date, contact the Texas Mammography Accreditation Program at (512) 834-6688 extension 2246</p>
</div>
...
<div class="Section" id="Location-Change">
	...
	<ul>
		<li>
			Complete the appropriate sections of the Amendment Application for Mammography Certification and submit to the Mammography Program<br/>
			<a title="RC 230-2, Amendment Application for Mammography Certification" href="http://www.dshs.state.tx.us/WorkArea/linkit.aspx?LinkIdentifier=id&amp;ItemID=8589981246">RC 230-2, Amendment Application for Mammography Certification</a> <span class="small">(PDF, 131KB)</span>.
		</li>
...
<div class="Section" id="Equipment-Changes">
	...
	<hr/>
	<h2>Mammography Equipment Changes</h2>
	
	<h3>To Add a Mammography Unit</h3>
	<p><strong><em>If accredited with State of Texas</em></strong></p>
	<ul>
		<li>Contact Mammography Accreditation Program at (512) 834-6688 ext. 2246, at least 30 days prior to installation of the mammography unit, for information regarding the required documents, the correct forms and fees.</li>
	</ul>
	<p><strong><em>If accredited with the American College of Radiology (ACR)</em></strong> </p>
	<ul>		
		<li>
			Complete and submit the Amendment Application for Mammography Certification<br/>
			<a title="RC 230-2, Amendment Application for Mammography Certification" href="http://www.dshs.state.tx.us/WorkArea/linkit.aspx?LinkIdentifier=id&amp;ItemID=8589981246">RC 230-2, Amendment Application for Mammography Certification</a> <span class="small">(PDF, 131KB)</span>.<br/>
		</li>
		<li>Submit a copy of the physicist’s survey report for the new unit</li>
		<li>Contact the ACR.</li>
	</ul>
...
<div class="Section" id="Personnel-Changes">
	...
	<ul>
		<li>
			<strong><em>Radiation Safety Officer (RSO)</em></strong> - Notify the Agency in writing within 30 days by completing and submitting either of the folliowing forms: 
				<ul>
					<li><a title="RC 230-2 Amendment Application for Mammography Certification" href="http://www.dshs.state.tx.us/WorkArea/linkit.aspx?LinkIdentifier=id&ItemID=8589981246">RC 230-2 Amendment Application for Mammography Certification</a> <span class="small">(PDF, 131KB)</span></li>
		...
		<li>
			<strong><em>Lead Interpreting Physician (LIP</em></strong>) - Notify the Agency in writing within 30 days by completing and submitting either of the following forms: 
			<ul>
				<li><a title="RC 230-2 Amendment Application for Mammography Certification" href="http://www.dshs.state.tx.us/WorkArea/linkit.aspx?LinkIdentifier=id&ItemID=8589981246">RC 230-2 Amendment Application for Mammography Certification</a> <span class="small">(PDF, 131KB)</span></li>
		...
		<li>
			<strong><em>Other Personnel Changes</em></strong> (Interpreting Physicians, Mammography Technologists and/or Medical Physicists) - Notify the Agency in writing within 30 days of additions or deletions of personnel.  Do not submit credentials with the request. Include the facility’s mammography certification number.
		</li>
		<li><strong><em>Accreditation Contact Person</em></strong> - Contact the State of Texas Mammography Accreditation Program (see the <a title="Mammography Accreditation page" href="/radiation/mammography/accreditation.aspx">Mammography Accreditation page</a> for more information) or the <a title="American College of Radiology" href="http://www.acr.org/Quality-Safety/Accreditation/Mammography">American College of Radiology</a>.</li>
	</ul>
</div>
...
<div class="Section" id="Terminating">
	...
	<ul>
		<li>Contact the facilities mammography accreditation body (State of Texas Mammography Accreditation Program or the American College of Radiology - ACR).</li>
		<li>Complete and submit <a title="RC 17-M, Request for Mammography Certification Termination" href="http://www.dshs.state.tx.us/WorkArea/linkit.aspx?LinkIdentifier=id&ItemID=20003">RC 17-M, Request for Mammography Certification Termination</a> <span class="small">(PDF, 17KB)</span>.</li>
	</ul>
</div>
...
<div class="Section" id="Additional-Information">
	...
	<p>For additional information see <a title="Frequently Asked Questions about Mammography Certification" href="/radiation/mammography/faq.aspx">Frequently Asked Questions about Mammography Certification</a>, or contact the Mammography Certification Program at (512) 834-6688 ext. 2225.</p>
</div>
