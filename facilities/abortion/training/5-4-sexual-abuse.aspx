...
<h2>Facts on Sexual Abuse of Children</h2>

<ul>
	<li>Offender is usually well-known to child</li>
	<li>Incest occurs within all socio-economic status</li>
	<li>Children rarely lie about sexual abuse</li>
	<li>Children often are blamed for the incestuous relationship</li>
	<li>Often sexual abuse is initialized before child reaches puberty</li>
	<li>Rarely do children present with physical signs indicative of sexual abuse</li>
</ul>
